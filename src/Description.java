...
public class Description {
    ...
    private String[] secondRoomDescription = {
            ...
            "A horrific smell Is filling the room...   it’s the smell of burned skin.",
    ...
    public String getRandomDescription() {
        ...
        String[] randomDescriptionList = new String[Room.amountRoom];

        return (" - You find yourself in a very " + getRandom(adjectiveListScarry) + " room. " + secondRoomDescription[Room.amountRoom]);
